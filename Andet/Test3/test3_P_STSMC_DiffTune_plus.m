...
saveas(h1, 'Plots\Test 3_DiffTune_plus P-STSMC_position error_all.png');
...
xlabel('time (s)');
ylabel('position error (mrad)');
title('DiffTune+ tuned P-STSMC: Position error, |e_\theta|', 'Interpreter', 'tex');
...
saveas(h2, 'Plots\Test 3_DiffTune_plus P-STSMC_position error_all_ver2.png');
