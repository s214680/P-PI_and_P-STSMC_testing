...
saveas(h1, 'Matlab plots\DiffTune\Testing P-STSMC DiffTune.png');
...
xlabel('time (s)');
ylabel('torque (N m)');
text(4.5,0.35,'d_e = 0.02 sin(t)');
title('Motor torque');

saveas(h1, 'Matlab plots\DiffTune\Testing P-STSMC DiffTune 0.02.png');
